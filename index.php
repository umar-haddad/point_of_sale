...
session_start();
// menggunakan variable sistem yaitu $_SESSION yang berfungsi untuk menampung data dalam 1 sesi
if (isset($_POST['user_email'])) {
    $email = htmlspecialchars($_POST['user_email'],  true);
    $password = htmlspecialchars(sha1($_POST['user_password']), true);
